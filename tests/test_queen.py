...
from chessington.engine.pieces import Queen, Pawn, King
...
class TestQueen():
    ...
    @staticmethod
    def test_white_queen_can_move_anywhere_in_bounds():
        # Arrange
        board = Board.empty()
        queen = Queen(Player.WHITE)
        row = 3
        col = 3
        queen_square = Square.at(row, col)
    ...
    @staticmethod
    def test_black_queen_can_move_anywhere_in_bounds():
        # Arrange
        board = Board.empty()
    ...
    @staticmethod
    def test_white_queen_stops_before_white_piece():
        # Arrange
        board = Board.empty()
        queen = Queen(Player.WHITE)
        row = 3
    ...
    @staticmethod
    def test_black_queen_stops_before_black_piece():
        # Arrange
        board = Board.empty()
        queen = Queen(Player.BLACK)
        row = 3
    ...
    @staticmethod
    def test_white_queen_stops_on_black_piece():
        # Arrange
        board = Board.empty()
        queen = Queen(Player.WHITE)
        row = 3
    ...
    @staticmethod
    def test_black_queen_stops_on_white_piece():
        # Arrange
        board = Board.empty()
        queen = Queen(Player.BLACK)
        row = 3
    ...
    @staticmethod
    def test_white_queen_stops_before_white_king():
        # Arrange
        board = Board.empty()
        queen = Queen(Player.BLACK)
        row = 3
    ...
    @staticmethod
    def test_black_queen_stops_before_white_king():
        # Arrange
        board = Board.empty()
        queen = Queen(Player.BLACK)
        row = 3
